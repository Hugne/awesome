...
mylauncher = awful.widget.launcher({ image = beautiful.awesome_icon,
                                     menu = mymainmenu })
obvious.clock.set_editor(terminal .. " -e " .. editor)
obvious.clock.set_shortformat("%a %b %d %H:%M %Z %Y")
obvious.clock.set_longformat("%a %b %d %H:%M %Z %Y")
obvious.clock.set_shorttimer("10")
obvious.clock.set_longtimer("60")
